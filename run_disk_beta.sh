#!/usr/bin/env bash
#SBATCH --job-name=disk_mom_1e6_beta         # Job name    (default: sbatch)
#SBATCH --output=disk_mom_1e6_beta.out        # Output file (default: slurm-%j.out)
#SBATCH --error=disk_mom_1e6_beta_%j.err         # Error file  (default: slurm-%j.err)
...
srun build-release/main/src/sphexa/sphexa --init '/home/lwatan/data/disk5_beta.hdf5' --prop std-angmom -s 1e6 -w 1000 -f m,c,x,y,z,rho,p,vx,vy,vz,h -o '/home/lwatan/scratch/run_disk_mom_1e6_beta.hdf5'
