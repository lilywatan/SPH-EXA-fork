#!/usr/bin/env bash
#SBATCH --job-name=disk_calibration_beta_planet_nohlim        # Job name    (default: sbatch)
#SBATCH --output=disk_calibration_beta_planet_nohlim.out        # Output file (default: slurm-%j.out)
#SBATCH --error=disk_calibration_beta_planet_nohlim_%j.err         # Error file  (default: slurm-%j.err)
...
#srun build-star0/main/src/sphexa/sphexa --init '/home/lwatan/data/disk5_beta.hdf5' --prop std-planet -s 1e6 -w 1000 -f c,m,x,y,z,rho,vx,vy,vz,h,u,temp,alpha,du_m1,x_m1,y_m1,z_m1 -o '/home/lwatan/scratch/run_disk_cal_1e6_beta_planet_nohlim_star0.hdf5'
