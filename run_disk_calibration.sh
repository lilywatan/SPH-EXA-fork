#!/usr/bin/env bash
#SBATCH --job-name=disk_calibration_beta_hydro         # Job name    (default: sbatch)
#SBATCH --output=disk_calibration_beta_hydro.out        # Output file (default: slurm-%j.out)
#SBATCH --error=disk_calibration_beta_hydro_%j.err         # Error file  (default: slurm-%j.err)
