...
# File paths
no_acc = '/home/lwatan/data/SPH-EXA-fork/output/runs/run_disk_cal_1e6_beta_2.hdf5'  # Calibration file
input_subgrid = '/home/lwatan/data/SPH-EXA-fork/subgrid_init.hdf5'  # Sub-grid file (empty)
beta = '/home/lwatan/data/disk5_beta.hdf5'

# Open all three files
with h5py.File(input_subgrid, 'a') as sub, h5py.File(no_acc, 'r') as cal, h5py.File(beta, 'r') as beta_file: 
    # Get the "Step#25" dataset from the calibration file
    cal_obj = cal['Step#25']
    
    # Get the "Step#25" dataset from the beta file
    ...
    ### Copy Attributes from `no_acc` to `input_subgrid`
