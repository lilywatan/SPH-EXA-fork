#!/usr/bin/env bash
#SBATCH --job-name=disk_calibration_beta_planet_3         # Job name    (default: sbatch)
#SBATCH --output=disk_calibration_beta_planet_3.out        # Output file (default: slurm-%j.out)
#SBATCH --error=disk_calibration_beta_planet_3_%j.err         # Error file  (default: slurm-%j.err)
...
srun build-release/main/src/sphexa/sphexa --init '/home/lwatan/data/disk5_beta.hdf5' --prop std-planet -s 1e6 -w 1000 -f m,x,y,z,rho,vx,vy,vz,h,u,temp,alpha,du_m1,x_m1,y_m1,z_m1 -o '/home/lwatan/scratch/run_disk_cal_1e6_beta_planet_3.hdf5'
