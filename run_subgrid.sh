#!/usr/bin/env bash
#SBATCH --job-name=disk_subgrid_beta_planet_debug         # Job name    (default: sbatch)
#SBATCH --output=disk_subgrid_beta_planet_debug.out        # Output file (default: slurm-%j.out)
#SBATCH --error=disk_subgrid_beta_planet_debug.err         # Error file  (default: slurm-%j.err)
...
srun $EXEC_PATH --init '/home/lwatan/data/SPH-EXA-fork/subgrid_init_planet.hdf5' --prop std-subgrid -s 10 -w 1000 -f m,c,x,y,z,rho,p,vx,vy,vz,h -o '/home/lwatan/scratch/run_subgrid_beta_planet_debug_14.hdf5'
