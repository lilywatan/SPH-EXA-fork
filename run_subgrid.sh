#!/usr/bin/env bash
#SBATCH --job-name=disk_subgrid_1e6_beta         # Job name    (default: sbatch)
#SBATCH --output=disk_subgrid_1e6_beta.out        # Output file (default: slurm-%j.out)
#SBATCH --error=disk_subgrid_1e6_beta_%j.err         # Error file  (default: slurm-%j.err)
