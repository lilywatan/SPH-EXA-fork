#!/usr/bin/env bash
#SBATCH --job-name=disk_subgrid_beta_planet_star0_1-2lim         # Job name    (default: sbatch)
#SBATCH --output=disk_subgrid_beta_planet_star0_1-2lim.out        # Output file (default: slurm-%j.out)
#SBATCH --error=disk_subgrid_beta_planet_star0_1-2lim.err         # Error file  (default: slurm-%j.err)
...
srun $EXEC_PATH --init '/home/lwatan/data/SPH-EXA-fork/subgrid_init_planet_star0.hdf5' --prop std-subgrid -s 20000 -w 500 -f m,c,x,y,z,rho,p,vx,vy,vz,h -o '/home/lwatan/scratch/run_subgrid_beta_planet_star0_1-2lim.hdf5'
