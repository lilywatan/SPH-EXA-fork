#!/usr/bin/env bash
#SBATCH --job-name=disk_subgrid_beta_planet_debug_no_AC         # Job name    (default: sbatch)
#SBATCH --output=disk_subgrid_beta_planet_debug_no_AC.out        # Output file (default: slurm-%j.out)
#SBATCH --error=disk_subgrid_beta_planet_debug_no_AC.err         # Error file  (default: slurm-%j.err)
...
rm -f '/home/lwatan/scratch/run_subgrid_beta_planet_debug_no_AC.hdf5'

srun $EXEC_PATH --init '/home/lwatan/data/SPH-EXA-fork/disk5_beta.hdf5' --prop std-subgrid -s 10 -w 10 -f m,c,x,y,z,rho,p,vx,vy,vz,h -o '/home/lwatan/scratch/run_subgrid_beta_planet_debug_no_AC.hdf5'
