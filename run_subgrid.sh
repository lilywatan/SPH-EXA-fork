#!/usr/bin/env bash
#SBATCH --job-name=disk_subgrid_beta_planet_star0_3         # Job name    (default: sbatch)
#SBATCH --output=disk_subgrid_beta_planet_star0_3.out        # Output file (default: slurm-%j.out)
#SBATCH --error=disk_subgrid_beta_planet_star0_3.err         # Error file  (default: slurm-%j.err)
...
srun $EXEC_PATH --init '/home/lwatan/data/SPH-EXA-fork/subgrid_init_planet_star0.hdf5' --prop std-subgrid -s 1e6 -w 1000 -f m,c,x,y,z,rho,p,vx,vy,vz,h -o '/home/lwatan/scratch/run_subgrid_beta_planet_star0_3.hdf5'
